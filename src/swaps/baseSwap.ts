 ...
 * @property {BigNumber} sqrtPriceX96 - The square root of the price after the swap times 2^96, used for precision in
 *     calculations.
...
abstract class BaseSwap {
    ...
    public calculatePriceImpact(
        ...
        const priceAfter: Decimal = sqrtPriceX96ToDecimal(this.sqrtPriceX96, token0BigNumbers, token1BigNumbers);
