...
const UNISWAP_V3_AFLAB_CONTRACT_ADDRESS: string = process.env.UNISWPV3_CONTRACT_ADDRESS ?? "";
...
async function main() {
    ...
    if (!AAVE_POOL_ADDRESS_PROVIDER_CONTRACT_ADDRESS) {
        throw new Error("AAVE_POOL_ADDRESS_PROVIDER_CONTRACT_ADDRESS is not set");
    }
