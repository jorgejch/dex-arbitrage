export default [
    {
        ...
        ], name: "executeOperation", outputs: [
            {
                internalType: "bool", name: "isSuccess", type: "bool",
            },
                ...
                components: [
                    {
                        ...
                        ], internalType: "struct UniswapV3Arbitrage.SwapInfo", name: "swap1", type: "tuple",
                    }, {
                        components: [
                            {
                                internalType: "address", name: "tokenIn", type: "address",
                        ...
                        ], internalType: "struct UniswapV3Arbitrage.SwapInfo", name: "swap2", type: "tuple",
                    }, {
                        components: [
                            {
                                internalType: "address", name: "tokenIn", type: "address",
                        ...
                        ], internalType: "struct UniswapV3Arbitrage.SwapInfo", name: "swap3", type: "tuple",
                    }, {
                        internalType: "uint256", name: "extraCost", type: "uint256",
                    },
                ], internalType: "struct UniswapV3Arbitrage.ArbitInfo", name: "data", type: "tuple",
            }, {
                internalType: "uint256", name: "tokenAIn", type: "uint256",
            },
        ], name: "initiateFlashLoan", outputs: [], stateMutability: "payable", type: "function",
    }, {
        inputs: [
            {
        ...
        ], name: "ArbitrageConcluded", type: "event",
    }, {
        anonymous: false, inputs: [
            {
                indexed: true, internalType: "uint32", name: "executionId", type: "uint32",
        ...
        ], name: "FlashLoanSuccess", type: "event",
    }, {
        anonymous: false, inputs: [
            {
                indexed: true, internalType: "uint32", name: "executionId", type: "uint32",
        ...
        ], name: "FlashloanError", type: "event",
    }, {
        anonymous: false, inputs: [
            {
        ...
        ], name: "NativeTokenWithdrawn", type: "event",
    }, {
        anonymous: false, inputs: [
            {
        ...
        anonymous: false, inputs: [
            {
                ...
                indexed: false, internalType: "uint256", name: "amount0Delta", type: "uint256",
            }, {
                indexed: false, internalType: "uint256", name: "amount1Delta", type: "uint256",
            },
        ...
        inputs: [], name: "getBalanceReceived", outputs: [
            {
                internalType: "uint256", name: "", type: "uint256",
            },
        ], stateMutability: "view", type: "function",
    }, {
        inputs: [], name: "getExecutionCounter", outputs: [
            {
